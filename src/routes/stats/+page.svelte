...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-3">
	...
	<div class="card bg-base-100/70 border border-white/5 col-span-2 lg:col-span-1">
		<div class="card-body p-4 flex-row items-center justify-between lg:flex-col lg:items-start lg:justify-start lg:gap-0">
			<div>
				<div class="text-xs text-base-content/50 uppercase tracking-wide">Collection value</div>
				<div class="text-xl lg:text-2xl font-black text-secondary">🪙 {formatGold(data.collectionValue)}</div>
			</div>
	...
	<div class="hidden lg:block card bg-base-100/70 border border-white/5">
		<div class="card-body p-4">
			<div class="text-xs text-base-content/50 uppercase tracking-wide">Cards owned</div>
			<div class="text-2xl font-black">{data.collectionCount}</div>
		</div>
	</div>
</div>
...
{#if s.bestPull}
	...
	<div class="card bg-base-100/70 border border-white/5 mb-3 overflow-hidden">
		<div class="card-body p-3 flex-row items-center gap-3">
			<div class="w-14 lg:w-20 shrink-0 aspect-[5/7] rounded-lg overflow-hidden {s.bestPull.foil ? 'foil-shimmer' : ''} {r.ring}">
			...
			<div class="min-w-0">
				...
				<div class="font-bold truncate lg:text-xl">{s.bestPull.name}</div>
...
<div class="lg:grid lg:grid-cols-2 lg:gap-3 lg:items-start">
<!-- money flow -->
<div class="card bg-base-100/70 border border-white/5 mb-3 lg:mb-0">
